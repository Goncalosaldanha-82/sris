"""
Tests for the SRIS Epistemic Engine lifecycle governance.

These tests verify that epistemic status changes are explicit,
authority-governed and auditable.
"""
...
"""Create a valid lifecycle transition request for testing."""
...
with pytest.raises(
ValueError,
match="Cannot create a transition event",
):
