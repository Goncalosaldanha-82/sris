...
2. Definir `ATLAS_ENV=production` e um `ATLAS_JWT_SECRET` aleatório com pelo
   ...
   controlo.
3. Confirmar que a migração `20260808_0002` terminou sem erro.
...
7. Só depois configurar o segredo OpenAI e ativar `SRIS_AI_ENABLED=true`.
8. Executar um smoke test de IA e verificar que as citações correspondem a IDs
...
- limites de custo/rate limiting por organização e painel de consumo;
