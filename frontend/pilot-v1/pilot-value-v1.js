(()=>{
  ...
  function ensureTabs(){
    ...
    if(!tabs.querySelector('[data-pp-extension="value"]')){
      const valueButton=document.createElement('button');valueButton.type='button';valueButton.className='pp-custom-tab';valueButton.dataset.ppExtension='value';valueButton.textContent='Value Case';tabs.appendChild(valueButton);
  ...
  function renderValue(){
    if(!state.value)return'<div class="pp-card"><div class="note">A sincronizar o Value Case…</div></div>';
